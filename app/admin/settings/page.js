...
import LayoutUser from "../../layoutUser"; // Asegúrate de que el path sea correcto
import { Box, Button, Container, Grid, TextField, Typography } from '@mui/material';
import styles from './settings.module.css';

export default function Page() {
    return (
        <LayoutUser>  {/* Asegúrate de que LayoutUser esté envolviendo correctamente el contenido */}
